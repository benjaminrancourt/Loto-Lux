...
// Definitions by: Paul David-Sivelle <https://github.com/Paul-DS>
// Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped

/// <reference path="../jquery/index.d.ts"/>
// <reference path="../jquery/jquery.d.ts"/>

declare namespace BootstrapYearCalendar {
    /**
...
import BYC = BootstrapYearCalendar;
...
interface JQuery {
     ...
     */
    calendar(options: BYC.CalendarOptions<BYC.CalendarDataSourceElement>): BYC.BaseCalendar;
     ...
     * @param options The customization options.
     */
    calendar<T extends BYC.CalendarDataSourceElement>(options: BYC.CalendarOptions<T>): BYC.Calendar<T>;
     ...
     */
    clickDay(handler: (e: BYC.CalendarClickEventObject<BYC.CalendarDataSourceElement>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    clickDay<T extends BYC.CalendarDataSourceElement>(handler: (e: BYC.CalendarClickEventObject<T>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    dayContextMenu(handler: (e: BYC.CalendarDayEventObject<BYC.CalendarDataSourceElement>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    dayContextMenu<T extends BYC.CalendarDataSourceElement>(handler: (e: BYC.CalendarDayEventObject<T>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    mouseOnDay(handler: (e: BYC.CalendarDayEventObject<BYC.CalendarDataSourceElement>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    mouseOnDay<T extends BYC.CalendarDataSourceElement>(handler: (e: BYC.CalendarDayEventObject<T>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    mouseOutDay(handler: (e: BYC.CalendarDayEventObject<BYC.CalendarDataSourceElement>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    mouseOutDay<T extends BYC.CalendarDataSourceElement>(handler: (e: BYC.CalendarDayEventObject<T>) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    renderEnd(handler: (e: BYC.CalendarRenderEndEventObject) => void): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    selectRange(handler: (e: BYC.CalendarRangeEventObject) => void): JQuery;
}

declare module 'bootstrap-year-calendar' {
    export = BootstrapYearCalendar;
}